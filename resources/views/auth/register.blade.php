            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="estd" class="col-md-6 col-form-label text-md-right">{{ __('Established') }}</label>

                            <div class="col-md-6">
                                <input id="estd" type="date" class="form-control @error('estd') is-invalid @enderror" name="estd" value="{{ old('estd') }}" required autocomplete="estd" autofocus>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline">
                                    <input id="male" type="radio" class="form-check-input @error('gender') is-invalid @enderror" name="gender" value="male" required autofocus>
                                    <label class="form-check-label" for="male">Male</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input id="female" type="radio" class="form-check-input @error('gender') is-invalid @enderror" name="gender" value="female" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <input id="customer" type="hidden" class="form-check-input" name="role" value="0">
